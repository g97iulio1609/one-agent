...
import { execute as sdkExecute } from '../../framework/engine';
  ...
  return {
    ...
    delegateToNutrition: tool({
      ...
      execute: async (input: {
        ...
        try {
          ...
          const { generateNutritionPlan } = await import('@giulio-leone/one-nutrition');
    ...
    delegateToFlight: tool({
      ...
      execute: async (input: {
        ...
        const { executeFlightSearch } = await import('@giulio-leone/one-flight');
